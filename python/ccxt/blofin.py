...
class blofin(Exchange):
    ...
    def cancel_all_orders(self, symbol=None, params={}):
        ...
        #     'instId': instId,
        # }
        orders = self.fetch_open_orders(instId)
        stopOrders = self.fetch_open_stop_orders(instId)
        ordersToCancel = []
        ...
        # response = self.v1PrivatePostTradeCancelOrder(self.extend(request, params))
        # self.v1PrivatePostTradeCancelTpsl(self.extend(request, params))
        #
        #     {
        #         "success":true,
        ...
        #     }
        #
        return self.v1PrivatePostTradeCancelBatchOrders(ordersToCancel)
    ...
    def fetch_balance(self, params={}):
        ...
        """
        self.load_markets()
        response = self.v1PrivateGetAssetBalances({
            'accountType': 'futures',
        })
        #
        #     {
    ...
    def fetch_leverage(self, symbol, params={}):
        ...
        response = self.v1PrivateGetAccountLeverageInfo(self.extend(request, params))
        #
        #     {
        #        "code": "0",
        #        "data": [
    ...
    def fetch_account_configuration(self, symbol, params={}):
        ...
        marginModeResponse = self.v1PrivateGetAccountMarginMode(marginModeRequest)
        ...
        posModeRes = self.v1PrivateGetAccountBatchLeverageInfo(posModeRequest)
