...
class woofi(Exchange):

    def describe(self):
        return self.deep_extend(super(woofi, self).describe(), {
            'id': 'woofi',
            'name': 'WOOFI',
    ...
    async def cancel_algo_order(self, id, symbol=None, params={}):
        ...
        response = await self.v1PrivateDeleteAlgoOrderOid(self.extend(request, params))
        #
    ...
    async def cancel_all_orders(self, symbol=None, params={}):
        ...
        await self.v1PrivateDeleteAlgoOrdersPending(self.extend(request, params))
        #
        #     {
        #         "success":true,
    ...
    async def fetch_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        #     }
        #
        ordersData = self.safe_value(ordersResponse, 'data', {})
        ordersRows = self.safe_value(ordersData, 'rows', [])
        total = 0
        algoOrdersRows = []
        for i in range(0, 50):
            request['size'] = 50
            ...
            algoOrdersResponse = await self.v1PrivateGetAlgoOrders(self.extend(request, params))
            ...
            if total >= knownTotal:
                break
        allOrdersData = self.array_concat(ordersRows, algoOrdersRows)
    ...
    async def fetch_ticker(self, symbol, params={}):
        ...
        response = await self.v1PublicGetFuturesSymbol(self.extend(request, params))
        #
        # {
        #   "symbol": "BTC-USDT",
        #   "priceChange": "10.00",
