...
class bybit(Exchange):
    ...
    async def is_uta_2(self, params={}):
        enableUta2 = self.safe_value(self.options, 'enableUta2')
        if enableUta2 is None:
            response = await self.privateGetV5AccountInfo()
    ...
    async def query_uid(self, params={}):
        response = {}
        try:
            response = await self.privateGetV5UserGetMemberType(params)
    ...
    async def fetch_balance(self, params={}):
        ...
        enableUta2 = await self.is_uta_2()
        type = None
    ...
    async def cancel_all_unified_account_orders(self, symbol=None, params={}):
        ...
        response = await self.privatePostV5OrderCancelAll(finalParams)
        #
        #     {
        #         "retCode": 0,
        #         "retMsg": "OK",
    ...
    async def fetch_my_trades(self, symbol=None, since=None, limit=None, params={}):
        ...
        if isUsdcSettled:
            # return await self.fetchMyUsdcTrades(symbol, since, limit, query)
            return []
        else:
    ...
    async def fetch_unified_positions(self, symbols=None, params={}):
        ...
        response = await getattr(self, method)(finalParams)
        #
        #     {
        #         "retCode": 0,
        #         "retMsg": "Success",
    ...
    async def fetch_derivatives_positions(self, symbols=None, params={}):
        ...
        if subType == 'inverse':
            finalParams = self.omit(finalParams, ['settleCoin'])
        finalParams['limit'] = 200
        response = await self.privateGetV5PositionList(finalParams)
        #
        #     {
        #         "retCode": 0,
        #         "retMsg": "OK",
    ...
    def parse_position(self, position, market=None):
        ...
        timestamp = self.parse8601(self.safe_string_2(position, 'updated_at', 'updated_time'))
        if timestamp is None:
            timestamp = self.safe_integer_2(position, 'updatedAt', 'updatedTime')
    ...
    async def set_derivatives_margin_mode(self, marginMode, symbol=None, params={}):
        ...
        # TEALSTREET
        response = await self.privatePostV5PositionSwitchIsolated(args)
        #
        #     {
        #         "retCode": 0,
        #         "retMsg": "OK",
