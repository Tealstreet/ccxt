...
class blofin(Exchange):
    ...
    async def set_margin_mode(self, marginMode, symbol=None, params={}):
        ...
        return await self.v1PrivatePostAccountSetMarginMode(self.extend(request, params))
    ...
    async def set_position_mode(self, hedged, symbol=None, params={}):
        ...
        return await self.v1PrivatePostAccountSetPositionMode(self.extend(request, params))
