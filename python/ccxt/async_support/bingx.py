...
class bingx(Exchange):
    ...
    async def switch_isolated(self, symbol, isIsolated, buyLeverage, sellLeverage, params={}):
        if isIsolated:
            await self.set_margin_mode('ISOLATED', symbol, params)
        else:
            await self.set_margin_mode('CROSSED', symbol, params)
    ...
    async def set_margin_mode(self, marginMode, symbol=None, params={}):
        ...
        try:
            return await self.swap2OpenApiPrivatePostSwapV2TradeMarginType(self.extend(request, params))
    ...
    async def set_position_mode(self, hedged, symbol=None, params={}):
        ...
        #     }
        #
        return await self.swap2OpenApiPrivatePostSwapV1PositionSideDual(self.extend(request, params))
    ...
    async def fetch_account_configuration(self, symbol, params={}):
        ...
        marginTypeResponse = await self.swap2OpenApiPrivateGetSwapV2TradeMarginType(self.extend(request, params))
        marginTypeData = self.safe_value(marginTypeResponse, 'data')
        positionModeResponse = await self.swap2OpenApiPrivateGetSwapV1PositionSideDual(self.extend(request, params))
    ...
    async def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        triggerType = self.safe_string_lower_2(params, 'trigger', 'workingType')
    ...
    async def cancel_all_orders(self, symbol=None, params={}):
        ...
        response = await self.swap2OpenApiPrivateDeleteSwapV2TradeAllOpenOrders(request)
        return response
