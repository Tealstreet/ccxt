...
class bitget(Exchange):
    ...
    async def fetch_deposits(self, code=None, since=None, limit=None, params={}):
        ...
        response = await self.privateSpotGetWalletDepositList(self.extend(request, params))
        #
        #      {
        #          "code": "00000",
        #          "msg": "success",
    ...
    async def fetch_withdrawals(self, code=None, since=None, limit=None, params={}):
        ...
        if limit is not None:
            request['pageSize'] = limit
        response = await self.privateSpotGetWalletWithdrawalList(self.extend(request, params))
        #
        #      {
        #          "code": "00000",
        #          "msg": "success",
    ...
    async def fetch_funding_rate(self, symbol, params={}):
        ...
        response = await self.publicMixGetMarketCurrentFundRate(self.extend(request, params))
        #
        #     {
        #         "code": "00000",
        #         "msg": "success",
    ...
    async def fetch_funding_history(self, symbol, since=None, limit=None, params={}):
        ...
        :param dict params: extra parameters specific to the bitget api endpoint
        :returns [dict]: a list of `funding history structures <https://docs.ccxt.com/en/latest/manual.html#funding-history-structure>`
        """
        await self.load_markets()
        market = self.market(symbol)
        if not market['swap']:
        ...
        if limit is not None:
            request['pageSize'] = limit
        response = await self.privateMixGetAccountAccountBill(self.extend(request, params))
        #
        #    {
        #        "code": "00000",
        #        "msg": "success",
    ...
    async def switch_isolated(self, symbol, isIsolated, buyLeverage, sellLeverage, params={}):
        # XXX-TEALSTREET-XXX
        if isIsolated:
            await self.set_margin_mode('fixed', symbol, params)
        else:
    ...
    async def fetch_open_interest(self, symbol, params={}):
        ...
        response = await self.publicMixGetMarketOpenInterest(self.extend(request, params))
        #
        #     {
        #         "code": "00000",
        #         "msg": "success",
