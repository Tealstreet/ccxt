...
class bybit extends Exchange {
    ...
    public function is_uta_2($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            if ($enableUta2 === null) {
                $response = Async\await($this->privateGetV5AccountInfo ());
    ...
    public function query_uid($params = array ()) {
        return Async\async(function () use ($params) {
            $response = array();
            try {
                $response = Async\await($this->privateGetV5UserGetMemberType ($params));
            } catch (Exception $e) {
                $response = array();
            }
            $result = $this->safe_value($response, 'result', array());
    ...
    public function fetch_balance($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            $enableUta2 = Async\await($this->is_uta_2());
            $type = null;
    ...
    public function parse_contract_order($order, $market = null) {
        ...
        $trigger = $this->safe_string($order, 'triggerBy');
        $slTriggerBy = $this->safe_string($order, 'slTriggerBy');
        if ($trigger === null && $slTriggerBy !== '') {
            $trigger = $slTriggerBy;
        }
        $tpTriggerBy = $this->safe_string($order, 'tpTriggerBy');
        if ($trigger === null && $tpTriggerBy !== '') {
            $trigger = $slTriggerBy;
        }
        if ($trigger === 'LastPrice') {
            $trigger = 'Last';
        } elseif ($trigger === 'IndexPrice') {
            $trigger = 'Index';
    ...
    public function create_position_trade_stop($symbol, $type, $side, $amount, $price = null, $params = array ()) {
        return Async\async(function () use ($symbol, $type, $side, $amount, $price, $params) {
            Async\await($this->load_markets());
            $market = $this->market($symbol);
    ...
    public function fetch_my_trades($symbol = null, $since = null, $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            if ($isUsdcSettled) {
                // return Async\await($this->fetchMyUsdcTrades ($symbol, $since, $limit, $query));
                return array();
            } else {
    ...
    public function fetch_position($symbol, $params = array (), $first = true) {
        return Async\async(function () use ($symbol, $params, $first) {
            /**
    ...
    public function set_derivatives_margin_mode($marginMode, $symbol = null, $params = array ()) {
        return Async\async(function () use ($marginMode, $symbol, $params) {
            ...
            // TEALSTREET
            $response = Async\await($this->privatePostV5PositionSwitchIsolated ($args));
            //
            //     {
            //         "retCode" => 0,
            //         "retMsg" => "OK",
    ...
    public function set_position_mode($hedged, $symbol = null, $params = array ()) {
        return Async\async(function () use ($hedged, $symbol, $params) {
            ...
            //     }
            //
            return Async\await($this->privatePostV5PositionSwitchMode (array_merge($request, $params)));
        }) ();
    }
