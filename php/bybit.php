...
class bybit extends Exchange {
    ...
    public function cancel_all_unified_account_orders($symbol = null, $params = array ()) {
        ...
        $response = $this->privatePostV5OrderCancelAll ($finalParams);
        //
        //     {
        //         "retCode" => 0,
        //         "retMsg" => "OK",
    ...
    public function cancel_all_unified_margin_orders($symbol = null, $params = array ()) {
        ...
        $response = $this->privatePostUnifiedV3PrivateOrderCancelAll ($finalParams);
        //
        //     {
        //         "retCode" => 0,
        //         "retMsg" => "OK",
    ...
    public function cancel_all_derivatives_orders($symbol = null, $params = array ()) {
        ...
        $response = $this->privatePostContractV3PrivateOrderCancelAll ($finalParams);
        //
        // contract v3
        //
        //     {
    ...
    public function fetch_account_configuration($symbol, $params = array ()) {
        ...
        $isUnified = $market['linear'] && $this->is_unified_enabled();
        if ($isUnified) {
    ...
    public function fetch_unified_positions($symbols = null, $params = array ()) {
        ...
        $response = $this->$method ($finalParams);
        //
        //     {
        //         "retCode" => 0,
        //         "retMsg" => "Success",
    ...
    public function fetch_derivatives_positions($symbols = null, $params = array ()) {
        ...
        $finalParams['limit'] = 200;
        $response = $this->privateGetV5PositionList ($finalParams);
        //
        //     {
        //         "retCode" => 0,
        //         "retMsg" => "OK",
