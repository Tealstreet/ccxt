...
class blofin extends Exchange {
    ...
    public function cancel_algo_order($id, $symbol = null, $params = array ()) {
        ...
        $response = $this->v1PrivatePostTradeCancelTpsl (array( array_merge($request, $params) ));
        //
    ...
    public function cancel_all_orders($symbol = null, $params = array ()) {
        ...
        //     'instId' => $instId,
        // );
        $orders = $this->fetch_open_orders($instId);
        $stopOrders = $this->fetch_open_stop_orders($instId);
        ...
        // $response = $this->v1PrivatePostTradeCancelOrder (array_merge($request, $params));
        // $this->v1PrivatePostTradeCancelTpsl (array_merge($request, $params));
        //
        //     {
        //         "success":true,
        ...
        //     }
        //
        return $this->v1PrivatePostTradeCancelBatchOrders ($ordersToCancel);
    }
    ...
    public function fetch_leverage($symbol, $params = array ()) {
        ...
        $response = $this->v1PrivateGetAccountLeverageInfo (array_merge($request, $params));
        //
        //     {
        //        "code" => "0",
        //        "data" => array(
    ...
    public function fetch_account_configuration($symbol, $params = array ()) {
        ...
        $marginModeResponse = $this->v1PrivateGetAccountMarginMode ($marginModeRequest);
        ...
        $posModeRes = $this->v1PrivateGetAccountBatchLeverageInfo ($posModeRequest);
