...
export default class bitget extends Exchange {
    ...
    parseTrade (trade, market = undefined) {
        ...
        side = this.safeString (trade, 'posSide');
        let price = this.safeString2 (trade, 'fillPrice', 'price');
        price = this.safeString (trade, 'priceAvg');
        ...
        let fee = undefined;
        const feeAmount = this.safeString2 (trade, 'fees', 'fee');
